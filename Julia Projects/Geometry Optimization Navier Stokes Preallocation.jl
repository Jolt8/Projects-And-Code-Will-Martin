...
typeof(rebuild_fvm_geometry)

preallocate(rebuild_fvm_geometry, cell_volumes, cell_centroids, connection_areas, connection_normals, connection_distances, unconnected_areas, unconnected_normals)

preallocate(rebuild_fvm_geometry, 
    cell_neighbor_map, neighbor_map_respective_node_ids, 
    unconnected_cell_face_map, unconnected_map_respective_node_ids,
    new_node_coordinates, nodes_of_cells
)
