...
K_gibbs_free(298u"K", reactor_inlet_temperature - 60u"K", 33.2u"kJ/mol", 49.4u"kJ/mol")
K_gibbs_free(298u"K", reactor_inlet_temperature - 30u"K", 33.2u"kJ/mol", 49.4u"kJ/mol")
K_gibbs_free(298u"K", reactor_inlet_temperature + 0u"K", 33.2u"kJ/mol", 49.4u"kJ/mol")
K_gibbs_free(298u"K", reactor_inlet_temperature + 30u"K", 33.2u"kJ/mol", 49.4u"kJ/mol")
K_gibbs_free(298u"K", reactor_inlet_temperature + 60u"K", 33.2u"kJ/mol", 49.4u"kJ/mol")
...
""" 
function pbr_ode_system!(du, u, p, catalyst_weight)
    ...
    for (i, chemical) in enumerate(components)
        du[i + 2] = total_species_rates[chemical]
    end
    ...
    for component in components
        current_model = PR([model.components[i]])
    ...
    du[1] = dT_dW * 0.001 #For the change in heat throughout the reactor
